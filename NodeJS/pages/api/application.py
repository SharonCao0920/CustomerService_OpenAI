...
# print("Generated Answer:", answer_question(df, question=question))


json_result = json.dumps(answer_question(df, question=question))

# Print the JSON data only, without any additional text
print(json_result)